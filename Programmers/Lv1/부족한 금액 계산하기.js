...
function solution(price, money, count) {
  ...
  const differenceOfAmount = totalPrice - money;
  return differenceOfAmount < 0 ? 0 : differenceOfAmount;
}
